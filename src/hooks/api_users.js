 ...
 * @returns array role
 */
export async function loadListRoles(token) {
    const url = baseUrl + 'user_management/roles';
 ...
 * @returns 
 */
export async function insertUser(token, user) {
    const url = baseUrl + 'user_management';
